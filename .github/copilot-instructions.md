...
`common-operating-picture` — Process-safe A2A coordination ledger — fcntl-locked task registry with bid/claim bounty board for multi-agent collision avoidance.
